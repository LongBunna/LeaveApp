							...
							<div class="x_content">
								...
								<form class="form-horizontal form-label-left">
									...
									<div class="form-group pull-right">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<a class="btn btn-app" style="border-radius:15px; !important">Export</a> 
											<a class="btn btn-app" style="border-radius:15px; !important">All requests</a>
											<a class="btn btn-app" style="border-radius:15px; !important">Pending requests</a>
										</div>
									</div>
